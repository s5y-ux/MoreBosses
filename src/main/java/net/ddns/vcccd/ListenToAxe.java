...
public class ListenToAxe implements Listener{
	...
	private void ParticleEffect(Entity parameter) {
		...
		for (int i = 0; i < 360; i=i+18) {
            ...
            parameter.getWorld().spawnParticle(Particle.SMALL_FLAME, location.getX() + Xoffset, location.getY(), location.getZ() + Yoffset, 1);
        }
	}
	...
	public void Axe(EntityDamageByEntityEvent event) {
		...
		Piglin damager = (Piglin) event.getDamager();
